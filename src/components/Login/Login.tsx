        ...
        <div className="rounded-2xl border border-gray-800 bg-gray-900 p-5 sm:p-6">
          <form onSubmit={handleLoginSubmit}>
            ...
            <button
              ...
              className="inline-flex w-full items-center justify-center mt-4 rounded-xl bg-indigo-500 px-4 py-2.5 text-white cursor-pointer disabled:bg-gray-500 disabled:cursor-not-allowed"
            >
              Submit
            </button>
          </form>
